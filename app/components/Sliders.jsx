...
export default function FeaturedProductSlider({ featuredProducts }) {
    ...
    const settings = {
        ...
        fade: true,
        // Add these callbacks to track the active slide
                        ...
                        <div className="px-4 py-8 md:p-16 rounded-lg relative">
                            ...
                            <div className="flex flex-col md:flex-row md:gap-12 items-center relative z-10">
                                ...
                                <div className="flex-1 flex flex-col gap-4 md:gap-6 text-center md:text-left mb-8 md:mb-0">
                                    ...
                                    {/* Only render interactive elements when the slide is active */}
                                    {activeSlide === index ? (
                                        <>
                                        ...
                                        <>
                                            {/* Non-interactive versions for inactive slides */}
                                            <h1 className="font-serif font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-gray-800 leading-tight">
                                                {product.title}
                                            </h1>
                                            ...
                                            {/* Static button placeholders */}
                                            <div className="flex flex-wrap gap-3 sm:gap-4 justify-center items-center md:justify-start mt-3">
                                                <div className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-4 sm:px-6 py-2.5 rounded-full flex items-center gap-2 text-xs sm:text-sm opacity-70">
                                                    <CreditCard className="w-4 h-4" />
                                                    Acquire
                                                </div>
                                                
                                                <div className="border border-blue-400 bg-white text-blue-500 px-4 sm:px-6 py-2.5 rounded-full flex items-center gap-2 text-xs sm:text-sm opacity-70">
                                                    <ShoppingCart className="w-4 h-4" />
                                                    Add to Cart
                                                </div>

                                                <div className="p-2 bg-white shadow-sm rounded-full opacity-70">
                                ...
                                {activeSlide === index ? (
                                    ...
                                    <div className="flex-shrink-0 w-full flex justify-center md:w-auto perspective">
