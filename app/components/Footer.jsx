        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1">
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Featured Art</a></li>
            ...
            <div className="col-span-1">
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">About the Artist</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Artist Statement</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Shipping & Returns</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Commission Process</a></li>
            ...
            <div className="col-span-1">
              ...
              <p className="text-gray-400 mb-4">Subscribe to receive updates on new artwork and upcoming exhibitions.</p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400 text-sm">&copy; {currentYear} Artist Name. All rights reserved.</p>
