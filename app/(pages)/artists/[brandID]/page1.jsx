  ...
  return (
    <main className="relative">
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10 py-8 relative z-10">
        ...
        {/* Contact/Commission Section - Cleaner layout */}
        <div className="mb-16 relative z-10">
          <div className="flex items-center mb-8">
            <div className="h-px flex-1 bg-stone-200"></div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-stone-100">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-stone-600 mb-6">Interested in commissioning {artist.name} for a custom artwork? Fill out the form to start a conversation about your vision.</p>
                  ...
                  {artist.email && (
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href={`mailto:${artist.email}`} className="text-amber-700 hover:text-amber-800 transition-colors text-sm">{artist.email}</a>
                      </div>
                    </div>
                  )}
                  ...
                  {artist.phone && (
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href={`tel:${artist.phone}`} className="text-amber-700 hover:text-amber-800 transition-colors text-sm">{artist.phone}</a>
                      </div>
                    </div>
                  )}
                ...
                <div className="mt-8">
                  ...
                  <ol className="space-y-2">
                    <li className="flex items-start">
                      <div className="h-5 w-5 rounded-full bg-amber-600 flex items-center justify-center text-white text-xs mr-2">1</div>
                      <span className="text-stone-600 text-sm">Initial consultation to discuss your vision</span>
                    </li>
                    <li className="flex items-start">
                      <div className="h-5 w-5 rounded-full bg-amber-600 flex items-center justify-center text-white text-xs mr-2">2</div>
                      <span className="text-stone-600 text-sm">Concept sketches and approval</span>
                    </li>
                    <li className="flex items-start">
                      <div className="h-5 w-5 rounded-full bg-amber-600 flex items-center justify-center text-white text-xs mr-2">3</div>
                      <span className="text-stone-600 text-sm">Creation of the artwork with progress updates</span>
                    </li>
                    <li className="flex items-start">
                      <div className="h-5 w-5 rounded-full bg-amber-600 flex items-center justify-center text-white text-xs mr-2">4</div>
              ...
              <div className="bg-stone-50 p-5 rounded-lg">
                ...
                <form className="space-y-3">
                  ...
                  <div>
                    <label htmlFor="subject" className="block text-sm font-medium text-stone-600 mb-1">Subject</label>
                    <input 
                      type="text" 
                      id="subject" 
                      className="w-full px-3 py-2 border border-stone-300 rounded-lg focus:ring-1 focus:ring-amber-500 focus:border-transparent transition-all text-sm"
                  ...
                  <div>
                    <label htmlFor="budget" className="block text-sm font-medium text-stone-600 mb-1">Budget Range (USD)</label>
                    <select 
                      id="budget" 
                  ...
                  <div>
                    <label htmlFor="message" className="block text-sm font-medium text-stone-600 mb-1">Your Vision</label>
                    <textarea 
                      id="message" 
                      rows="4" 
                      className="w-full px-3 py-2 border border-stone-300 rounded-lg focus:ring-1 focus:ring-amber-500 focus:border-transparent transition-all text-sm"
                  ...
                  <div className="pt-2">
                    <button 
                      type="submit" 
                      className="w-full py-2.5 bg-amber-600 hover:bg-amber-700 text-white font-medium rounded-lg shadow transition-colors"
                    >
                      Send Request
                    </button>
                    <p className="text-xs text-stone-500 mt-2 text-center">You'll receive a response within 48 hours</p>
                  </div>
                </form>
              </div>
            </div>
